...
- `garments.html`、`garment-data.js`、`garment-review-status.js`、`garments.js`：46 款成衣参考目录、公开核验门禁和询价状态
- `styles.css`：响应式视觉样式
...
- 经营方已于 2026-07-16 确认当前 46 款均对应真实成品样衣；公开图采用标准化目录呈现，规格、库存和商业条件仍需逐款核验。
